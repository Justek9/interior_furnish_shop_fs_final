...
function getProducts() {
    return [
        ...
        },
        {
            ...
            price: 40,
            description: 'Versatile and stylish wall-mounted shelf in universal color.',
            isNew: false,
            category: 'shelves',
        },
        {
        ...
        },
        {
            ...
            price: 140,
            description: 'This season most fashionable solution, will add charm to any interior.',
            isNew: false,
            category: 'storage organizers',
        },
        {
            ...
            price: 155,
            description: 'Especially recommended for people who value practical and original solutions.',
            isNew: false,
            category: 'storage organizers',
        },
    ];
...
async function seed() {
    ...
    await Promise.all(getImgs().map((img) => {
